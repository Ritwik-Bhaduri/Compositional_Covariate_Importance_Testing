...
df <- df %>%
  mutate(
    Method = case_when(
      str_detect(control_methods, "univariate-BH") ~ "LOO-BH",
      str_detect(control_methods, "univariate-Holm") ~ "LOO-Holm",
...
fdr_plot_1 = my_plot(name = "ERROR", model_name = "softmax_log_normal", error_type_name = 'fdr', fdr_method_shortlist=c("LOO-BH", "BCP(p-1)-BH","BCP(p/2)-BH","BCP(s+1)-BH"))
fdr_plot_2 = my_plot(name = "Power", model_name = "softmax_log_normal", error_type_name = 'fdr', fdr_method_shortlist=c("LOO-BH", "BCP(p-1)-BH","BCP(p/2)-BH","BCP(s+1)-BH"))
fdr_plot = ggarrange(fdr_plot_1, fdr_plot_2, common.legend = TRUE, legend = "right")
fdr_plot
ggsave("plots/fdr_logistic_normal.pdf", plot = fdr_plot, device = "pdf", width = 7, height = 3, units = "in")

fwer_plot_1 = my_plot(name = "ERROR", model_name = "softmax_log_normal", error_type_name = 'fwer', fwer_method_shortlist=c("LOO-Holm", "BCP(p-1)-Holm","BCP(p/2)-Holm","BCP(s+1)-Holm"))
fwer_plot_2 = my_plot(name = "Power", model_name = "softmax_log_normal", error_type_name = 'fwer', fwer_method_shortlist=c("LOO-Holm", "BCP(p-1)-Holm","BCP(p/2)-Holm","BCP(s+1)-Holm"))
fwer_plot = ggarrange(fwer_plot_1, fwer_plot_2, common.legend = TRUE, legend = "right")
fwer_plot 
ggsave("plots/fwer_logistic_normal.pdf", plot = fwer_plot, device = "pdf", width = 7, height = 3, units = "in")
