...
CRT_p_val = function(data, method = "lasso", rho = 0.6, CRT.replications = 100, 
                     CRT.method_array = c("d0_CRT"), suppress.messages = TRUE, seed = NULL,null_j=NULL,...){
  start_time = Sys.time()
  set.seed(seed)
