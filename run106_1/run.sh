...
#SBATCH -p janson_cascade,janson_bigmem,janson,janson_sapphire,sapphire,shared,seas_compute,serial_requeue # Partition
# #SBATCH -p janson_cascade,janson_bigmem,janson # Partition
#SBATCH -c 1 # number of cores
#SBATCH -t 0-01:00  # Running time in the format - D-HH:MM
