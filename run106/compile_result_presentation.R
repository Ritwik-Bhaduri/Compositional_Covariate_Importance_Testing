...
library(ggpubr)
library(dplyr)
setwd("/n/home07/rbhaduri/projects/Markov blanket for manifold supported covariates/run106/")
...
df_summary$Method = factor(df_summary$Method, levels = c("BCP(p-1)", "BCP(p/2)", "BCP(s+1)", "LOO"))
