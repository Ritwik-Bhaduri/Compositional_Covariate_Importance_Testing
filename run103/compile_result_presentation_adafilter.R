...
df <- df %>%
  mutate(
    Method = case_when(
      str_detect(control_methods, "adafilter_oracle_11") ~ "adafilter(s+1)-BH",
      str_detect(control_methods, "adafilter_oracle_50") ~ "adafilter(p/2)-BH",
      str_detect(control_methods, "adafilter_oracle_99") ~ "adafilter(p-1)-BH",
      str_detect(control_methods, "adafilter_bonferroni_oracle_11") ~ "adafilter(s+1)-Bonferroni",
      str_detect(control_methods, "adafilter_bonferroni_oracle_50") ~ "adafilter(p/2)-Bonferroni",
      str_detect(control_methods, "adafilter_bonferroni_oracle_99") ~ "adafilter(p-1)-Bonferroni",
      ...
      str_detect(control_methods, "Simes_oracle_99") & error_type=="fdr" ~ "BCP(p-1)-BH",
      ...
      str_detect(control_methods, "Simes_holm_oracle_99") & error_type=="fwer" ~ "BCP(p-1)-Holm",
      TRUE ~ "Other"
    )
  ) %>%
  filter(Method %in% c("adafilter(s+1)-BH", "adafilter(p/2)-BH", "adafilter(p-1)-BH", 
                       "adafilter(s+1)-Bonferroni", "adafilter(p/2)-Bonferroni", "adafilter(p-1)-Bonferroni",
                       "BCP(s+1)-BH","BCP(p/2)-BH","BCP(p-1)-BH",
                       "BCP(s+1)-Holm","BCP(p/2)-Holm","BCP(p-1)-Holm"))
df$control_methods = factor(df$Method, levels = c("adafilter(s+1)-BH", "adafilter(p/2)-BH", "adafilter(p-1)-BH", 
                                                  "adafilter(s+1)-Bonferroni", "adafilter(p/2)-Bonferroni", "adafilter(p-1)-Bonferroni",
                                                  "BCP(s+1)-BH", "BCP(p/2)-BH", "BCP(p-1)-BH",
                                                  "BCP(s+1)-Holm", "BCP(p/2)-Holm", "BCP(p-1)-Holm"))
...
cbPalette <- c("#8A2BE2", "#4767CD", "#47B9CD","#FA9400", "#FE0000", "#6B0000")
...
my_plot <- function(name = "ERROR", model_name = "dirichlet", error_type_name = 'fdr',fdr_method_shortlist=NULL, fwer_method_shortlist=NULL){
  ...
  p = p + scale_color_manual(values = cbPalette, 
                             labels = labels_expr) +
    scale_linetype_manual(values = c("solid", "twodash", "dotted", "dashed", "dotdash", "longdash"),
                          labels = labels_expr)
  return(p)
}

fdr_plot_1 = my_plot(name = "ERROR", model_name = "dirichlet", error_type_name = 'fdr', fdr_method_shortlist = c("adafilter(s+1)-BH", "adafilter(p/2)-BH", "adafilter(p-1)-BH", "BCP(p/2)-BH", "BCP(p-1)-BH", "BCP(s+1)-BH"))
fdr_plot_2 = my_plot(name = "Power", model_name = "dirichlet", error_type_name = 'fdr', fdr_method_shortlist = c("adafilter(s+1)-BH", "adafilter(p/2)-BH", "adafilter(p-1)-BH", "BCP(p/2)-BH", "BCP(p-1)-BH", "BCP(s+1)-BH"))
...
fwer_plot_1 = my_plot(name = "ERROR", model_name = "dirichlet", error_type_name = 'fwer', fwer_method_shortlist = c("adafilter(s+1)-Bonferroni", "adafilter(p/2)-Bonferroni", "adafilter(p-1)-Bonferroni", "BCP(p-1)-Holm", "BCP(p/2)-Holm", "BCP(s+1)-Holm"))
fwer_plot_2 = my_plot(name = "Power", model_name = "dirichlet", error_type_name = 'fwer', fwer_method_shortlist = c("adafilter(s+1)-Bonferroni", "adafilter(p/2)-Bonferroni", "adafilter(p-1)-Bonferroni", "BCP(p-1)-Holm", "BCP(p/2)-Holm", "BCP(s+1)-Holm"))
...
fdr_plot_1 = my_plot(name = "ERROR", model_name = "normal", error_type_name = 'fdr', fdr_method_shortlist = c("adafilter(s+1)-BH", "adafilter(p/2)-BH", "adafilter(p-1)-BH", "BCP(p/2)-BH", "BCP(p-1)-BH", "BCP(s+1)-BH"))
fdr_plot_2 = my_plot(name = "Power", model_name = "normal", error_type_name = 'fdr', fdr_method_shortlist = c("adafilter(s+1)-BH", "adafilter(p/2)-BH", "adafilter(p-1)-BH", "BCP(p/2)-BH", "BCP(p-1)-BH", "BCP(s+1)-BH"))
fdr_plot = ggarrange(fdr_plot_1, fdr_plot_2, common.legend = TRUE, legend = "right")
fdr_plot
ggsave("plots/with adafilter/fdr_normal.pdf", plot = fdr_plot, device = "pdf", width = 7, height = 3, units = "in")


fwer_plot_1 = my_plot(name = "ERROR", model_name = "normal", error_type_name = 'fwer', fwer_method_shortlist = c("adafilter(s+1)-Bonferroni", "adafilter(p/2)-Bonferroni", "adafilter(p-1)-Bonferroni", "BCP(p-1)-Holm", "BCP(p/2)-Holm", "BCP(s+1)-Holm"))
fwer_plot_2 = my_plot(name = "Power", model_name = "normal", error_type_name = 'fwer', fwer_method_shortlist = c("adafilter(s+1)-Bonferroni", "adafilter(p/2)-Bonferroni", "adafilter(p-1)-Bonferroni", "BCP(p-1)-Holm", "BCP(p/2)-Holm", "BCP(s+1)-Holm"))
fwer_plot = ggarrange(fwer_plot_1, fwer_plot_2, common.legend = TRUE, legend = "right")
fwer_plot 
